...
@ApplicationScoped
public class BillingAddressRelation implements Relation<BillingAddress, Integer> {
    ...
    @Override
    public BillingAddress get(Key<Integer> key) {
    ...
    @Override
    public ArrayList<BillingAddress> get() {
    ...
    @Override
    public void put(BillingAddress item) {
    ...
    @Override
    public void delete(BillingAddress item) {
