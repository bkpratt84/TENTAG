...
@FacesValidator("existingNewUser")
public class ExistingNewUser implements Validator {
    //private static final Logger logger = Logger.getLogger("ExistingNewUser");

    private final DbContext dbContext;
    private final AdminUserController ctrl;
    
    public ExistingNewUser() {
